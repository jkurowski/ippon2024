        ...
        <div class="card-head container-fluid">
            <div class="row">
                <div class="col-6 pl-0">
                    <h4 class="page-title"><i class="fe-grid"></i>Nagrody</h4>
                </div>
                <div class="col-6 d-flex justify-content-end align-items-center form-group-submit">
                    <a href="{{route('admin.awards.create')}}" class="btn btn-primary">Dodaj wpis</a>
                </div>
            </div>
        </div>
        <div class="card mt-3">
                ...
                <table id="sortable" class="table mb-0">
                    ...
                    @foreach ($list as $item)
                        <tr id="recordsArray_{{ $item->id }}">
                            ...
                            <td>
                                @if($item->file)
                                    <img src="/uploads/awards/{{$item->file}}" alt="{{ $item->name }}" style="margin:0 auto">
                                @endif
                            </td>
...
@endsection
@push('scripts')
    <script type="text/javascript">$(document).ready(function(){$("#sortable tbody.content").sortuj('{{route('admin.awards.sort')}}');});</script>
@endpush
